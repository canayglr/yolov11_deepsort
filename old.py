...
while cap.isOpened():
    ...
    if ret:
        ...
        results = model(frame, device=0, classes=2, conf=0.8)
        ...
        araba_count = len(unique_track_ids)
        ...
        cv2.putText(og_frame, f"Araba Sayisi: {araba_count}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
